...
include_once('../dbConnection.php');
 ...
 if(isset($_REQUEST['updateStuNameBtn'])){
  if(($_REQUEST['stuName'] == "")){
   ...
   $passmsg = '<div class="alert alert-warning" style="width:fit-content;font-size: 14px;
    padding: 5px 30px;
   ...
   $passmsg = '<div class="alert alert-success" style="width:fit-content;font-size: 14px;
    padding: 5px 30px;
    margin-top: -35px; margin-left: 90px;">Updated Successfully</div>';
   } else {
   // below msg display on form submit failed
   $passmsg = '<div class="alert alert-danger" style="width:fit-content;font-size: 14px;
                padding: 5px 30px;
                 margin-top: -35px; margin-left: 0px;">Unable to Update</div>';
      }
    }
 }
?>
...
<div class="stuContent">
    <div class="formContent">
      ...
      <!-- Student doesnt mean school student it also means learner -->
       ...
       <button type="submit" class="signinbutton" name="updateStuNameBtn">Update</button>
