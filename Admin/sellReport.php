...
?>
  ...
  <div class="container" style="margin-top:100px;">
      <form action="" method="POST" class="d-print-none">
        <div class="form-row" style="display: flex;justify-content: center;align-items: center;flex-direction: row;font-size:20px">
          ...
          <div class="form-group" >
            <input type="submit" class="signinbutton" name="searchsubmit" value="Search">
          </div>
        </div>
      </form>
      <?php
